    ...
    <div className="card bg-base-200 hover:bg-base-300 hover:shadow-lg transition-all duration-300 group border border-base-300 hover:border-primary/20">
      <div className="card-body p-4 sm:p-5">
        ...
        <Link 
          ...
          className="btn btn-primary w-full gap-2 group-hover:btn-primary-focus group-hover:scale-105 active:scale-95 transition-all duration-200 hover:shadow-lg"
          title={`Send message to ${friend.fullName}`}
          aria-label={`Start conversation with ${friend.fullName}`}
        >
